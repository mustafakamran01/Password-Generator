...
function App() {
  ...
  // Taking all the fields to update in UI
  ...
  // Taking reference of input field to add effects like selection
  const passwordRef = useRef()

  // Running this method whenever there is any changes in the given dependencies
  useEffect( () => {
    generatePassword()
